        ...
        <div class="info-container">
          ...
          <div class="cards-block">
            <div class="card-line">
              ...
              <div class="card-wrap">
                <AgendaUser mobile :speaker-name="'Андрій Мандріка'" :subtitle="'Як побудувати успішний продукт, який допомагає ЗСУ. Висновки з кейсу B2B-підписки на донати в фонді KOLO'" :showSpeaker="showSpeaker" />
              </div>
            </div>
          </div>
      ...
      <div class="stage fourteen">
        ...
        <div class="info-container">
          ...
          <div class="cards-block">
            ...
            <div class="card-alone">
              <h4 class="role">Модератор</h4>
              <AgendaUser :speaker-name="'Ася Гарбузова'" :showSpeaker="showSpeaker" />
            </div>
          </div>
